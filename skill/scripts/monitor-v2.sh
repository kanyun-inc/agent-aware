#!/bin/bash
# Agent-aware 监听脚本 v2
# 用途：监听用户项目根目录的 .agent-aware/ 目录
# 基于 SPEC-SKILL-002: Monitor Script 重构
#
# 适配 SPEC-SRV-005 Detector 架构重构：
# - 监听 behavior.json 和 error.json
...
ERROR_FILE="${AGENT_AWARE_DIR}/error.json"
BEHAVIOR_FILE="${AGENT_AWARE_DIR}/behavior.json"

echo "🔍 开始监控 Agent-aware 检测文件"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📁 监控目录: ${AGENT_AWARE_DIR}"
echo "📝 错误文件: error.json (优先级: 高)"
echo "📝 行为文件: behavior.json (优先级: 中)"
